...
**change global font**(line)

**change the padding and margin and shadow**(shape)

**change the words color **(texture)
...
![step 7](https://github.com/CS571-S24/hw3-new-Noah-wang/blob/main/_figures/step7.jpg?raw=true)
